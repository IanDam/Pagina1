...
box1= Image.open("box1.png")
box2= Image.open("box2.png") 
box3= Image.open("box3.png") 
box4= Image.open("box4.png") 
box5= Image.open("box5.png") 
box6= Image.open("box6.png") 
box7= Image.open("box7.png") 
box8= Image.open("box8.png") 
box9= Image.open("box9.png") 
pair1= Image.open("pair1.png")
propo1= Image.open("propo.png")
rela1= Image.open("rela1.png") 
visu1= Image.open("visu1.png") 
visu2= Image.open("visu2.png") 
visu3= Image.open("visu3.png") 
visu4= Image.open("visu4.png") 
visu5= Image.open("visu5.png") 
visu6= Image.open("visu6.png") 
visu7= Image.open("visu7.png") 
visu8= Image.open("visu8.png") 
...
st.image("maharanobis")
st.image("describe2")

st.subheader("Transformacion de datos:")
st.code("""data = data.astype({"Potability":"category"})""")
...
data["Trihalomethanes_2"] = pd.cut(data["Trihalomethanes"],4)""", lenguage="pyhton")
...
st.write("α=0.05")
st.code("""multivariate_normality(data2, alpha = .05 )""")
st.code("""HZResults(hz=1.1369243176166905, pval=4.509462445228134e-66, normal=False)""")
...
Columna Turbidity si sigue una distribución normal""", lenguage="python")
...
st.code("""" Ttest_indResult(statistic=-0.3046442883875845, pvalue=0.7606581670556812) """)
st.code("""" Ttest_indResult(statistic=-0.8647102836072975, pvalue=0.38726679870076297) """)
st.code("""" Ttest_indResult(statistic=0.595206325721168, pvalue=0.5517503508954078)""")
st.code("""" Ttest_indResult(statistic=1.343448411247364, pvalue=0.17922819297971626)""")
st.code("""" Ttest_indResult(statistic=0.09646877342917845, pvalue=0.9231547020388317)""")
st.code("""" Ttest_indResult(statistic=-0.1363821049180547, pvalue=0.8915283492717541)""")
st.code("""" Ttest_indResult(statistic=-1.007730107311136, pvalue=0.31366512921636786)""")
st.code("""" Ttest_indResult(statistic=0.9463387265442308, pvalue=0.344051884391254)""")
st.code("""" Ttest_indResult(statistic=0.35868790729516203, pvalue=0.7198537565149352)""")
...
st.code(""" (0.19004781886397173, 0.6628768212772176, 7.057552645613959, array([[568, 936],
        [581, 924]]))""")
st.code(""" (0.0036865865680039776,
 0.9515843796069338,
 196.9823785600006,
 array([[573, 931],
        [576, 929]]))""")
st.code(""" (0.007987662311864645,
 0.9287849061198299,
 20743.348404224074,
 array([[576, 928],
        [573, 932]]))""")
st.code(""" (3.0289037993276766, 0.0817932600039606, 7.116809283709961, array([[598, 906],
        [551, 954]]))""")
st.code(""" (0.01843152769512674, 0.8920088296205512, 334.0274201302968, array([[572, 932],
        [577, 928]]))""")
st.code(""" (0.01843152769512674, 0.8920088296205512, 420.5492185259853, array([[572, 932],
        [577, 928]]))""")
st.code(""" (0.6580003678108246,
 0.41726677745854024,
 14.243373528509892,
 array([[563, 941],
        [586, 919]]))""")
st.code(""" (1.4763614453103326, 0.2243446768114634, 66.50978010824268, array([[591, 913],
        [558, 947]]))""")
st.code(""" (0.09891667092292114, 0.7531335646890226, 3.955916726029925, array([[579, 925],
        [570, 935]]))""")
