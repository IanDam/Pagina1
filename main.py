...
st.image(visu1,caption="Poporciones de la variable ph, y de potability en estas")
...
st.image(visu2, caption="Poporciones de la variable solids, y de potability en estas")
...
st.image(visu3, caption="Poporciones de la variable hardness, y de potability en estas")
...
st.image(visu4,caption="Poporciones de la variable Chloramiines, y de potability en estas")
...
st.image(visu5,caption="Poporciones de la variable sulfure, y de potability en estas")
...
st.image(visu6,caption="Poporciones de la variable conductivity, y de potability en estas")
...
st.image(visu7,caption="Poporciones de la variable organic_carbon, y de potability en estas")
...
st.image(visu8,caption="Poporciones de la variable trihalomethanes, y de potability en estas")
...
st.image(visu9,caption="Poporciones de la variable turbidity, y de potability en estas")
...
st.image(propo1,caption="Proporcion de la variable potability")
...
st.image(box3,caption="Boxlpot de la variable solids" )
st.image(box4,caption="Boxlpot de la variable chloramines" )
st.image(box5,caption="Boxlpot de la variable sulfate" )
st.image(box6,caption="Boxlpot de la variable conductivity" )
st.image(box7,caption="Boxlpot de la variable organic_carbon" )
st.image(box8,caption="Boxlpot de la variable trihalomethanes" )
st.image(box9,caption="Boxlpot de la variable turbidity" )
